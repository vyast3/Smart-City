        ...
        <div id="layout">
            ...
            <div id="body_container">
                <div id="body_container_inner">
                    ...
                    <center>
                        <form action="HospitalRadioCalled" method="post">
                            <h3>
                                Select Type:
                    ...
                    <c:choose>
                        <c:when test="${requestScope.Operation == 'ShowCityName'}">
                            <sql:query var="cityquery" dataSource="${dsn1}">
                                SELECT distinct h.city FROM smartcity.hospital h where h.type = ?;
                                <sql:param value="${requestScope.type}" />
                            </sql:query>
                            <form action="HospitalInfoSearch" method="post">
            ...
            System.out.println("route name " + request.getAttribute("routeName"));
                    ...
                    <c:choose>
                        ...
                        <c:when test="${requestScope.Operation == 'HospitalInfoSearch'}">
                            <sql:query var="cityquery" dataSource="${dsn1}">
                                SELECT distinct h.city FROM smartcity.hospital h where h.type = ?;
                                <sql:param value="${requestScope.type}" />
                            </sql:query>
                            ...
                            <sql:query var="query2" dataSource="${dsn1}">
                                SELECT * FROM smartcity.hospital h where h.city like ?;
