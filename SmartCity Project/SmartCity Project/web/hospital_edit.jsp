        ...
        <script type="text/javascript">
            ...
            <%--location.href = "FeedbackAddServlet";--%>
                    ...
                    if(hospitalId =="" || type == "" || hospitalCity =="" || hospitalName =="" || hospitalAddress =="" || hospitalEmail ==""
                        ...
                        document.forms[0].action="/SmartCityNew/HospitalIUrlServlet";
                    document.forms[0].submit();
                    }else if(isNaN(hospitalContact))
                    {
                        alert("HospitalContact number should be number");
                         document.forms[0].action="/SmartCityNew/HospitalIUrlServlet";
                    document.forms[0].submit();
                    }
                    else if(hospitalContact.length != 10){
                        alert("Please enter 10 digit number");
                        document.forms[0].action="/SmartCityNew/HospitalIUrlServlet";
                        document.forms[0].submit();
                    }
                    else if(reg.test(hospitalEmail) == false) {
