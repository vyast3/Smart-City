...
public final class tourism_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    var inputFile = document.getElementById(\"inputFile\").value;\n");
      ...
      out.write("                        || location ==\"\" || attractive ==\"\" || waytoReach ==\"\" || helplineNo ==\"\" || inputFile ==\"\"){\n");
      out.write("                        alert(\"Field should not be empty\");\n");
      out.write("                        document.forms[0].action=\"/SmartCityNew/TourismAddServlet\";\n");
      out.write("                        document.forms[0].submit();\n");
      out.write("                    }else if(isNaN(helplineNo))\n");
      out.write("                    {\n");
      out.write("                        alert(\"Helpline number should be number\");\n");
      out.write("                        document.forms[0].action=\"/SmartCityNew/TourismAddServlet\";\n");
      out.write("                        document.forms[0].submit();\n");
      out.write("                    }\n");
      out.write("                    else if(helplineNo.length != 10){\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, PageContext _jspx_page_context)
    ...
    // /tourism_edit.jsp(85,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    ...
    if (_jspx_eval_c_005fwhen_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                        <tr>\n");
        out.write("                                            <td width=\"40%\">\n");
        out.write("                                                Attach image files:\n");
        out.write("                                            </td>\n");
        out.write("                                            <td width=\"60%\">\n");
        out.write("                                                <input type=\"file\" name=\"inputFile\" id=\"inputFile\" size=\"40\"/>\n");
        out.write("                                            </td>\n");
        out.write("                                        </tr>\n");
        out.write("\n");
        out.write("                                        <tr>\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fwhen_005f0, PageContext _jspx_page_context)
    ...
    // /tourism_edit.jsp(129,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
  ...
  private boolean _jspx_meth_c_005fredirect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fotherwise_005f0, PageContext _jspx_page_context)
    ...
    // /tourism_edit.jsp(255,16) name = url type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
